...
public class SQLServerCRUDExample {
   public static void main(String[] args) throws Exception {
      // args[0], args[1], args[2] = dbname, username, password
      String connectionUrl = "jdbc:sqlserver://dbsme.pknu.ac.kr:1433;databaseName=" + args[0] + ";user=" + args[1] + ";password=" + args[2];
